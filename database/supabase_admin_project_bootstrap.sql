...
with map(username, full_name, auth_email, app_role, staff_role, dashboard_route, phone) as (values
  ('Sandra',  'Sandra Bartolome',     'stf001@staff.import.pending','staff','fitness',  'staff_dashboard.html','+447516121704'),
  ('Roberto', 'Roberto Reali',        'stf002@staff.import.pending','staff','swimming', 'staff_dashboard.html','+447827567963'),
  ('Dan',     'Dan Clarke',           'stf003@staff.import.pending','staff','swimming', 'staff_dashboard.html','+447921219021'),
  ('Angel',   'Angel Falceto',        'stf004@staff.import.pending','staff','swimming', 'staff_dashboard.html','+447716582565'),
  ('Youssef', 'Youssef Moustafa',     'stf005@staff.import.pending','staff','swimming', 'staff_dashboard.html','+447919891212'),
  ('John',    'John Kyei-Fram',       'stf006@staff.import.pending','lead', 'support',  'lead_dashboard.html','+447741072712'),
  ('Bismark', 'Bismark Gyan',         'stf007@staff.import.pending','staff','support',  'staff_dashboard.html','+447510488944'),
  ('Giuseppe','Giuseppe Morelli',     'stf008@staff.import.pending','staff','support',  'staff_dashboard.html','+447541611664'),
  ('Godsway', 'Godsway Yatofo',       'stf009@staff.import.pending','staff','support',  'staff_dashboard.html','+447442797241'),
  ('Javier',  'Javier Marquez',       'stf010@staff.import.pending','staff','swimming', 'staff_dashboard.html','+447523494240'),
  ('Aurora',  'Aurora Garcia',        'stf011@staff.import.pending','staff','swimming', 'staff_dashboard.html','+447473228203'),
  ('Berta',   'Berta Trapero Casado', 'stf012@staff.import.pending','lead', 'support',  'lead_dashboard.html','+447523492621'),
  ('Victor',  'Victor',               'stf013@staff.import.pending','ceo',  'manager',  'ceo_dashboard.html','+447715444979'),
  ('Carlos',  'Carlos Herrero',       'stf014@staff.import.pending','staff','climbing', 'staff_dashboard.html','+447873439001'),
  ('Alex',    'Alex Stone',           'stf015@staff.import.pending','staff','climbing', 'staff_dashboard.html','+447414724084'),
  ('simon',   'Simon Griffiths',      'stf016@staff.import.pending','staff','swimming', 'staff_dashboard.html','+447775897684'),
  ('Javi',    'Javi Arranz Escorial', 'stf017@staff.import.pending','ceo',  'manager',  'ceo_dashboard.html', null),
  ('Raul',    'Raul',                 'stf018@staff.import.pending','ceo',  'manager',  'ceo_dashboard.html', null),
  ('Sevitha', 'Sevitha',              'stf019@staff.import.pending','admin','admin',    '/operations-admin/', null),
  ('demo',    'Demo',                 'stf020@staff.import.pending','staff','swimming', 'staff_dashboard.html', null),
  ('aida',    'Aida Lulia',           'stf021@staff.import.pending','staff','swimming', 'staff_dashboard.html','+447728281298'),
  ('andres',  'Andres Borrego',       'stf022@staff.import.pending','staff','climbing', 'staff_dashboard.html','+447864966958')
),
auth_map as (
