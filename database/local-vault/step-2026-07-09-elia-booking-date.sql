-- Show calendar date on Elia's one-off session booking line (same weight as time).
  ...
  '[
    {
      ...
      "displayLabel": "30'' Aquatic Activity · Tuesday 14 Jul 2026, 19:00–19:30 · Acton Centre"
    }
  ]'::jsonb
)
