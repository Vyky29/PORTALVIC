#!/usr/bin/env node
/**
 * Build step-staff-dm-push.local.sql from template + PORTAL_PUSH_WEBHOOK_SECRET.
 */
import fs from "fs";
...
const templatePath = path.join(__dirname, "step-staff-dm-push.template.sql");
const outPath = path.join(__dirname, "step-staff-dm-push.local.sql");
