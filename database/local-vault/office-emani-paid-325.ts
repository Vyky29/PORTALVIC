/**
 * Emani (376) · Sam · INV-P-0132 — bank £325 = Autumn 1st flexi half.
 *
 *   APPLY=1 npx -y deno run -A database/local-vault/office-emani-paid-325.ts
 */
...
const CONTACT_ID = "376";
const INVOICE_NUMBER = "INV-P-0132";
const RECEIVED = 325;
...
if (Number(row.amount_paid_gbp || 0) >= RECEIVED) {
  console.log("Already has £325+ paid — nothing to do.");
  Deno.exit(0);
}
...
const noteLine =
  "Office 16 Aug 2026: bank £325 = Autumn 1st flexi half. Office validated — Mark paid. Oct half still pending.";
