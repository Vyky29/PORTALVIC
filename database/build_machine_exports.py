...
def write_term_from_timetable_js(records, roster_rows=None):
    ...
    shift_dates_dashboard = term_staff_shift_dates_by_profile_key(
    ...
    body = (
        ...
        "// termStaffShiftDatesByProfileKey = exact shift dates (pool rota) for My Term blue/red from 1 Jun.\n"
