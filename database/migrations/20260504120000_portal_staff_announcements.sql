-- Portal staff announcements: admin/CEO publish; staff and leads read per audience_scope.
-- Independent of legacy public.announcements (other migrations); safe to apply on a fresh branch.
--
-- After apply: enable Realtime on this table if you want instant staff refresh (optional).
...
-- Admin / CEO: read all (history / diagnostics)
...
-- Leads: all_staff + leads-only rows
