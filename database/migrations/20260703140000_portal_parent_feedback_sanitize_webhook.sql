-- Sanitize session_feedback for the family portal when staff submit (OpenAI + cache).
-- Replace __PORTAL_PUSH_WEBHOOK_SECRET__ with PORTAL_PUSH_WEBHOOK_SECRET from Edge secrets.
-- Deploy: supabase functions deploy portal-parent-feedback-sanitize
