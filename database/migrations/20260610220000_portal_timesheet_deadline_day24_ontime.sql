-- Timesheet on-time deadline: submit by the 24th (London), last day of cycle 25->24.
-- Late from the 25th (penalty + next month's pay). Previously day 24 was treated as late.

begin;

comment on column public.staff_timesheets.is_late is
  'True when submitted on/after the 25th (deadline is the 24th). Late sheets roll to next month.';
...
begin
  ...
  -- On time through the 24th; late from the 25th (pay month already advances on the 25th+).
