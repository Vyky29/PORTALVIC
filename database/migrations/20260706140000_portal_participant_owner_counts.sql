-- Mirror of supabase/migrations/20260706140000_portal_participant_owner_counts.sql
--
...
values
  ...
  ('emanuel', 'Emanuel', 'youssef', 22),
  ('emanuel', 'Emanuel', 'michelle', 9),
  ('emanuel', 'Emanuel', 'raul', 8),
  ('emanuel', 'Emanuel', 'victor', 3),
  ('erik', 'Erik', 'dan', 4),
  ('erik', 'Erik', 'john', 4),
  ('erik', 'Erik', 'berta', 2),
  ('erik', 'Erik', 'aurora', 2),
