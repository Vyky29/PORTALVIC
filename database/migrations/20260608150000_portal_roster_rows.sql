-- Term timetable edits (Phase 1): weekly templates + dated exceptions in Supabase.
-- Spreadsheet/bundle remains baseline; portal_roster_rows override at read time in dashboards.
--
-- ROLLBACK (manual):
...
--   drop function if exists public.portal_roster_rows_set_updated();
--   drop table if exists public.portal_roster_row_events;
--   drop table if exists public.portal_roster_rows;
