...
-- Admin may insert external training certificates into a worker's My Documents.
...
-- Storage: reuse training folder path pattern ({user_id}/training/…).
-- insert/select policies for that folder already exist for L&D admin; ensure present.
