-- Routines / Planner: which tailored participant packs each staff user may see.
-- visualVIC reads staff_profiles.app_role + staff_participant_access for auth.uid().
