...
const SELECT_COLS =
  "id,client_name,session_date,service,attendance,engagement_rating,engagement_patterns,client_emotions,session_narrative,positive_feedback,relevant_information,completed_by_name,portal_session_key,session_time,created_at,swim_done,swim_engagement_rating,swim_regulation,swim_independence";
