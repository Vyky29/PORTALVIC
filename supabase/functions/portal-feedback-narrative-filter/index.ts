...
function buildMessages(body: Record<string, unknown>, strictRetry = false) {
  ...
  const system = [
    ...
    "- Session narrative only — what happened, participation, strategies that worked (only if stated).",
    "- Do NOT mention engagement scores, regulation/emotion labels, or independence/support levels — families see those in separate columns.",
    ...
    "- One or two short paragraphs, plain English. Vary wording every session — never reuse the same opening sentence.",
    "",
