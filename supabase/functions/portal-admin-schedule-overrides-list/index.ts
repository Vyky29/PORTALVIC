...
//
// portal-admin-schedule-overrides-list
// Active schedule_overrides for admin Sessions hub (service role; admin JWT verify).
...
const SELECT_COLS =
  "id,created_at,created_by,session_date,anchor_start,anchor_end,anchor_staff_id,anchor_venue,anchor_client_id,anchor_time_slot_label,override_type,reason,status,payload";
...
Deno.serve(async (req) => {
  ...
  if (error) {
    console.error("[portal-admin-schedule-overrides-list]", error.message);
