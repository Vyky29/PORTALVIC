...
const ROSTER_SPELLING_ALIASES: Record<string, string> = {
  ...
  abodi_p: "abodi_pa",
  aboodi: "abodi_patel",
  aboodi_patel: "abodi_patel",
  abodi_patel: "abodi_patel",
  saaib: "saiib",
  saaib_abdullah: "saiib",
  gap_saaib_abdullah: "saiib",
  adam_pi: "adam_p",
  amar_ra: "amar_rai",
  sammer: "samer",
  rayan_tapa: "rayan_ta",
...
/** ACAT Mon cohort members (Jack S/W, Kate, Kamy). Autumn 26/27 rows only when re-enrolled. */
