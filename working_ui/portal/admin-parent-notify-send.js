...
(function (global) {
  ...
  function formatNotifyError(err, data) {
    ...
    var map = {
      ...
      media_requires_whatsapp: 'Attachments can only be sent through WhatsApp.',
      media_requires_open_whatsapp_session: 'The parent must message the API number first. WhatsApp only allows photos, documents and audio during the 24-hour reply window.',
      media_too_large: 'Attachment too large (maximum 4 MB).',
      invalid_media: 'The attachment could not be read.',
      media_store_failed: 'The attachment could not be stored — try again.',
