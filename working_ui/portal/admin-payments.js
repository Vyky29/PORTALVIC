...
(function (global) {
  ...
  function injectStyleOnce() {
    var css = [
      ...
      ".pay-kpis{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin:0 0 12px;align-items:stretch}",
      ".pay-kpi{display:flex;align-items:center;justify-content:center;gap:12px;border-radius:14px;padding:14px 16px;border:1px solid transparent;min-width:0}",
      ...
      ".pay-kpi--billed{grid-column:1/-1;justify-self:center;width:min(100%,22rem);background:#eff6ff;border-color:#bfdbfe}",
      ".pay-kpi--billed .pay-kpi__ico{background:#dbeafe;color:#1d4ed8}",
      ".pay-kpi--billed span{color:#1e40af}",
      ".pay-kpi--billed b{color:#1e3a8a}",
      ".pay-kpi--paid{grid-column:1;justify-self:stretch;background:#ecfdf5;border-color:#a7f3d0}",
      ".pay-kpi--paid .pay-kpi__ico{background:#d1fae5;color:#047857}",
      ".pay-kpi--paid span{color:#047857}",
      ".pay-kpi--paid b{color:#166534}",
      ".pay-kpi--out{grid-column:2;justify-self:stretch;background:#fef2f2;border-color:#fecaca}",
