...
export async function bootstrapDashboardSupabase(_opts) {
  ...
  try {
    ...
    try {
      ...
      const perm = await import("./portal_location_permission.js?v=20260622-mandatory-perms");
      ...
      const loc = await import("./portal_location_tracker.js?v=20260605-mandatory-staff");
