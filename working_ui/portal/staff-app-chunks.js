...
(function (global) {
  ...
  var TIER_ROSTER = [
    "/portal/term_from_timetable.js?v=20260903-sun6-john-berta",
    ...
    "/portal/staff_dashboard_spreadsheet_adapter.js?v=20260903-john-hub-team",
    ...
    "/portal-shared-js/portal_late_submission.js?v=20260716-cancel-selfserve",
      ...
      "/portal/portal_roster_canonical.js?v=20260903-sun6-john-berta",
  ...
  var TIER_UI_MODULES = [
    ...
    "/portal/portal_lead_team_shift.js?v=20260903-sun6-john-berta",
  ];
  ...
  var EXTRACTED_BEFORE_AUTH = [
    ...
    "/portal/staff-dashboard-today.js?v=20260903-sun6-john-berta",
    "/portal/staff-dashboard-ui.js?v=20260903-sun6-john-berta",
