...
(function (global) {
  ...
  var TIER_ROSTER = [
    ...
    "/portal/staff_dashboard_spreadsheet_bundle.js?v=20260903-luliya-cards",
    "/portal/staff_dashboard_spreadsheet_adapter.js?v=20260903-luliya-cards",
    ...
    "/portal-shared-js/portal_late_submission.js?v=20260716-cancel-selfserve",
      ...
      "/portal/portal_roster_canonical.js?v=20260903-tue-acat-ikram",
  ...
  var TIER_UI_MODULES = [
    ...
    "/portal/portal_lead_team_shift.js?v=20260903-tue-acat-ikram",
  ];
  ...
  var EXTRACTED_BEFORE_AUTH = [
    ...
    "/portal/staff-dashboard-participants.js?v=20260903-tue-acat-ikram",
    "/portal/staff-dashboard-today.js?v=20260903-luliya-cards",
    "/portal/staff-dashboard-ui.js?v=20260903-tue-acat-ikram",
