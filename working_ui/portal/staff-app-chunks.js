...
(function (global) {
  ...
  var TIER_ROSTER = [
    ...
    "/portal-shared-js/portal_late_submission.js?v=20260716-cancel-selfserve",
      ...
      "/portal/portal_roster_canonical.js?v=20260920-dc-office-snap",
    ...
    "/portal/portal_resolve_day_board.js?v=20260920-dc-office-snap",
  ...
  var TIER_UI_MODULES = [
    ...
    "/portal/portal_lead_team_shift.js?v=20260920-berta-full-day",
  ];
