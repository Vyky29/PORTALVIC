...
(function (global) {
  ...
  var VER = "20260905-zaid-910";

  var TIER_ROSTER = [
    "/portal/term_from_timetable.js?v=20260906-luliya-cover-dates",
    ...
    "/portal-shared-js/portal_late_submission.js?v=20260716-cancel-selfserve",
      ...
      "/portal/portal_roster_canonical.js?v=20260906-luliya-cover-v64",
    ...
    "/portal/portal_staff_lead_aquatic_slots.js?v=20260905-zaid-two-cards",
  ...
  var TIER_DASH = [
    ...
    "/portal/staff-dashboard-today.js?v=20260906-merge-standing-v62",
