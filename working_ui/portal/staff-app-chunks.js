...
(function (global) {
  ...
  var VER = "20260913-roberto-lead-scan2";
  ...
  var TIER_ROSTER = [
    ...
    "/portal/staff_dashboard_spreadsheet_bundle.js?v=20260911-emmanuel-no-tue",
    ...
    "/portal-shared-js/portal_late_submission.js?v=20260716-cancel-selfserve",
      ...
      "/portal/portal_roster_canonical.js?v=20260913-muhammad-noon-trial",
  ...
  var TIER_UI = [
    ...
    "/portal/portal_dashboard_ui_coalesce.js?v=20260913-roberto-lead-idle",
  ...
  var TIER_UI_MODULES = [
    ...
    "/portal/portal_lead_team_shift.js?v=20260913-roberto-lead-scan2",
  ];
