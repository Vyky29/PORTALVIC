...
(function (global) {
  ...
  /* Injected by build-time perf patch on portalvic + clubsensational-staff. */
    ...
    var VER = "20260916-javier-wed-cyrus-ayman";
  ...
  var TIER_ROSTER = [
    ...
    "/portal-shared-js/portal_late_submission.js?v=20260716-cancel-selfserve",
      ...
      "/portal/portal_roster_canonical.js?v=20260916-javier-wed-cyrus-ayman",
  ...
  var TIER_UI_MODULES = [
    ...
    "/portal/portal_lead_team_shift.js?v=20260915-team-full-day",
  ];
