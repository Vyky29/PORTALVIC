...
(function (global) {
  ...
  var TIER_ROSTER = [
    "/portal/term_from_timetable.js?v=20260903-no-summer-departed",
    ...
    "/portal/staff_dashboard_spreadsheet_adapter.js?v=20260903-no-summer-departed",
    ...
    "/portal-shared-js/portal_late_submission.js?v=20260716-cancel-selfserve",
      ...
      "/portal/portal_roster_canonical.js?v=20260903-no-summer-departed",
  ...
  var TIER_UI_MODULES = [
    ...
    "/portal/portal_lead_team_shift.js?v=20260903-no-summer-departed",
  ];
  ...
  var EXTRACTED_BEFORE_AUTH = [
    ...
    "/portal/staff-dashboard-participants.js?v=20260903-no-summer-departed",
    "/portal/staff-dashboard-today.js?v=20260903-no-summer-departed",
    "/portal/staff-dashboard-ui.js?v=20260903-no-summer-departed",
