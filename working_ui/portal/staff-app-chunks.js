...
(function (global) {
  ...
  var TIER_ROSTER = [
    ...
    "/portal/staff_dashboard_spreadsheet_bundle.js?v=20260622-madre-unified",
  ...
  var TIER_UI = [
    ...
    "/portal/portal_sheet_back.js?v=20260614-dock-nav-v2",
  ];

  var TIER_UI_MODULES = [
    "/portal/portal_quick_menu_service_leads.js?v=20260621-pickup-lead-roster",
    "/portal/portal_lead_team_shift.js?v=20260621-team-subordinates-only",
  ];
