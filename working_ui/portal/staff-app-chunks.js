...
(function (global) {
  ...
  var VER = "20260908-serine-roberto-logan-luliya";
  ...
  var TIER_ROSTER = [
    ...
    "/portal/staff_dashboard_spreadsheet_bundle.js?v=20260907-joel-old-open",
    "/portal/staff_dashboard_spreadsheet_adapter.js?v=20260907-joel-old-open",
    ...
    "/portal-shared-js/portal_late_submission.js?v=20260716-cancel-selfserve",
      ...
      "/portal/portal_roster_canonical.js?v=20260908-serine-roberto-logan-luliya",
  ...
  var TIER_DASH = [
    ...
    "/portal/staff-dashboard-today.js?v=20260908-updated-admin-chip",
