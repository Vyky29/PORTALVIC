...
(function (global) {
  ...
  if (isStaffDashboard) {
    ...
    preloadScript("/portal/staff-dashboard-feedback.js?v=20260628-physical-activity-per-instructor");
    if (!isHandheld) {
  ...
  global.portalStaffDeferWebPush = function portalStaffDeferWebPush() {
    ...
    var urls = [
      ...
      "/portal/portal_alerts_notifications_ui.js?v=20260628-test-btn-fix",
    ];
    var i = 0;
    function next() {
