...
(function (global) {
  ...
  var VER = "20260625-reassign-wide-fix";
  ...
  if (isStaffDashboard) {
    ...
    preloadScript("/portal/staff-dashboard-dock-boot.js?v=20260625-reassign-wide-fix");
    preloadScript("/portal/staff-dashboard-topbar.js?v=20260625-reassign-wide-fix");
    preloadScript("/portal/staff-dashboard-feedback.js?v=20260625-reassign-wide-fix");
    if (!isHandheld) {
