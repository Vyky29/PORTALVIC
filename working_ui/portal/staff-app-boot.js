...
(function (global) {
  ...
  if (isStaffDashboard) {
    preloadScript("/portal/staff_dashboard_spreadsheet_bundle.js?v=20260703-bundle-iife");
  ...
  var STAFF_DEFERRED_HEAVY = [
    ...
    "/portal/portal_swimming_instructor_menus.js?v=20260707-topbar-profile-sticky-key",
