...
(function (global) {
  ...
  function viewHtml() {
    return (
      ...
      "Live Autumn Term places for families who call or email — same data as the Booking Portal, without the public gate. " +
      "Use this when matching the waiting list or placing a new client." +
      "</p></div>" +
  ...
  function daySectionHtml(day, rows) {
    ...
    return (
      ...
      '<table class="table" style="width:100%;min-width:36rem">' +
      "<thead><tr>" +
      "<th>Service</th><th>Venue</th><th>Time</th><th>Cap</th><th>Taken</th><th>Free</th>" +
      "</tr></thead><tbody>" +
      body +
