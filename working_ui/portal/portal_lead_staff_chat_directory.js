...
(function (global) {
  ...
  /** Full CS Cliq / messenger  only Raul, Javier (Palan), Victor, admin and CEO. */
  ...
  /** @deprecated Use portalStaffHasFullMessengerAccess  kept for call sites expecting this name. */
  function portalStaffIsLeadUser(prof) {
    return portalStaffHasFullMessengerAccess(prof);
  }

  /** Session lead on roster (e.g. Berta, John)  not the executive trio. */
