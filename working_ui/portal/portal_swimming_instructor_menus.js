  ...
  if (global.addEventListener) {
    ...
    var portalLateTopbarResync = function () {
      try {
        ...
        // #region agent log
        try{setTimeout(function(){var c=global.document&&global.document.getElementById('topbarToolCellSessionPlanner');fetch('http://127.0.0.1:7580/ingest/26d61b03-7462-4bdd-b8f7-734b28cdcaa9',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'035b4c'},body:JSON.stringify({sessionId:'035b4c',hypothesisId:'settled',location:'portal_swimming_instructor_menus.js:settled',message:'settledState',data:{planCellExists:!!c,planCellHidden:c?c.hidden:null,planCellAriaHidden:c?c.getAttribute('aria-hidden'):null},timestamp:Date.now()})}).catch(()=>{});},2000);}catch(_){}
        // #endregion
      } catch (_) {}
    };
