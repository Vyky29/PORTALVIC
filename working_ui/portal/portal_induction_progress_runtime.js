 ...
 */
import { bootstrapDashboardSupabase } from "/portal/auth-handler.js?v=20260921-induction-refresh";
...
async function bootInductionProgressRuntime() {
  try {
    ...
    await import("./portal_training_progress_sync.js?v=20260921-induction-refresh");
