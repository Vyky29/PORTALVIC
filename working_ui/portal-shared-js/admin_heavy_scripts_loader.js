...
(function () {
  ...
  var SETS = {
    roster: [
      "/portal/term_from_timetable.js?v=20260905-overview-thu-ma",
      ...
      "/portal/portal_roster_canonical.js?v=20260905-zaid-aquatic-trial-only",
    ...
    spreadsheet_ref: [
      ...
      "/portal/autumn_staff_hours_reference.js?v=20260903-tue-acat-ikram",
    ],
  };
